...
const About = () => {
    return ( <
        ...
        for my primary carrier path.Using Javascript I have been solving verious web related problems.In a modern day, React js library is very popular of developing UI
        for single page application.It is a Javascript library
        for front - end devvelopment.I have been gathering mass knowledge about React js.My plan is be hands on react js within 6 months.Side by side I have been learing Node Js
        for back - end development and also learning SQL and NoSQL
        for Database Query.OverAll after 1 year of learning verious web technologies and developing many projects using these technologies, I will be FullStack Web Developer InshaAllah. < /p> <
        /div>   <
        /div> <
        /div>
    );
